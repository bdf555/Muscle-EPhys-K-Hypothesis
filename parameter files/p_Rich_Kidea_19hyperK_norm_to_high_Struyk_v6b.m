...
save_file_prefix = 'Rich_Kidea_19hyperK_norm_to_high_Struyk_v6b';  % for saving output runs
...
pg_Rich_Kidea_19hyperK_norm_to_high_Struyk_v6b
...
protocol{1}.molecs_change.molec(1).mat = [3e7 -8 10000];
protocol{1}.molecs_change.molec(2).mat = [3e7 8 10000];
