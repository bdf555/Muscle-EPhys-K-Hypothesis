...
Molecs_base(1).init_extrac = 147.88;    % normal
%Molecs_base(1).init_extrac = 148;    % normal
...
%Molecs_base(1).init_intrac = 13.3;
Molecs_base(1).init_intrac = 15.8;
...
Molecs_base(2).init_extrac = 2.12;     % normal
%Molecs_base(2).init_extrac = 2;     % normal
...
%Molecs_base(2).init_intrac = 104;
Molecs_base(2).init_intrac = 91.5;
%Molecs_base(2).init_intrac = 105;
...
NaGatingPore.params(1) = 5*2.444e-9;   %NaYasc permeability, cm/s
