...
%NaPIC.params(1) = 3e-7;   %NaPIC permeability, cm/s
%NaPIC.params(1) = 6e-7;   %NaPIC permeability, cm/s
%NaPIC.params(1) = 3.6e-8;   %NaPIC permeability, cm/s
NaPIC.params(1) = 1.8e-8;   %NaPIC permeability, cm/s
%NaPIC.params(1) = 2.7e-8;   %NaPIC permeability, cm/s

%NaPIC.params(2) = -54;    %V50_S1, mV 
%NaPIC.params(2) = -57;    %V50_S1, mV 
%NaPIC.params(2) = -65;    %V50_S1, mV 
...
%NaPIC.params(7) = -64;    %V50_S2, mV
%NaPIC.params(7) = -67;    %V50_S2, mV
NaPIC.params(7) = -20;    %V50_S2, mV
%NaPIC.params(7) = -35;    %V50_S2, mV
NaPIC.params(8) = 3;    %Aslope_S2, mV
%NaPIC.params(8) = 12;    %Aslope_S2, mV
...
%NaPIC.params(1) = 3e-7;   %NaPIC permeability, cm/s
%NaPIC.params(1) = 6e-7;   %NaPIC permeability, cm/s
%NaPIC.params(1) = 1.7e-8;   %NaPIC permeability, cm/s
NaPIC.params(1) = 3.6e-8;   %NaPIC permeability, cm/s


NaPIC.params(2) = 0; %S1inf_init;
NaPIC.params(3) = 1; %S1inf_final;
NaPIC.params(4) = .33; %S1inf_rise = ;
NaPIC.params(5) = -65; %S1inf_offset = ;

NaPIC.params(6) = 5; %S1tau_init = ;
NaPIC.params(7) = 5; %S1tau_final = ;
NaPIC.params(8) = 1; %S1tau_rise = ;
NaPIC.params(9) = 0; %S1tau_offset = ;

NaPIC.params(10) = 1; %S1_exp = ;

NaPIC.params(11) = 1; %S2inf_init = ;
NaPIC.params(12) = 0; %S2inf_final = ;
NaPIC.params(13) = .33; %S2inf_rise = ;
NaPIC.params(14) = -20; %S2inf_offset = ;

NaPIC.params(15) = 5; %S2tau_init = ;
NaPIC.params(16) = 5; %S2tau_final = ;
NaPIC.params(17) = 1; %S2tau_rise = ;
NaPIC.params(18) = 0; %S2tau_offset = ;

NaPIC.params(19) = 1; %S2_exp = ;
