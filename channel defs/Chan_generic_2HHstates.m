function [out1, out2] = Chan_generic_2HHstates(states, V, params, flag, max_cond_factor, use_GHK, RTF, C, valence, varargin)
...
% several parameters below are not meant to be fit
...
if flag == 3 || flag == 4
    ...
    S1_inf = 1 ./ (1 + exp(S1_act.*(V-V50_S1)./Aslope_S1) );
    tau_S1 = tauS1_mag .* exp(- ((V - tauS1_Vmean)./tauS1_Vwidth).^2 );
    
    S2_inf = 1 ./ (1 + exp(S2_act.*(V-V50_S2)./Aslope_S2) );
